							...
							<div class="col-md-6">
								...
								<?php echo form_open('simpan','class="form"');?>
									<div class="input-group-icon mt-10">
										...
										<input type="number" name="no_telp" id="no_telp" value="<?php echo $this->session->userdata('no_telp'); ?>"class="input-register" placeholder="No. Handphone" required oninvalid="setCustomValidity('No Telpone Harus di Isi !')" oninput="setCustomValidity('')">										
